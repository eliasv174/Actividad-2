...
INSERT INTO `clientes` VALUES (3,'123456','LUIS','CRUZ','8797559','CIUDAD','1999-01-01');
...
CREATE TABLE `empleados` (
  ...
  KEY `fk1_idx` (`id_puesto`),
  CONSTRAINT `fk1` FOREIGN KEY (`id_puesto`) REFERENCES `puestos` (`id_puesto`)
...
INSERT INTO `empleados` VALUES (1,'E001','ELIAS','ZURA','CIUDAD','1234466','2002-10-20',1);
...
-- Dump completed on 2024-09-09 22:23:01
